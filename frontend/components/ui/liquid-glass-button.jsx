...
function LiquidButton({
  ...
  const Comp = asChild ? Slot : (href ? "a" : (as || "button"))

  if (asChild) {
    // If asChild is explicitly used, we must use React.cloneElement to inject our complex DOM
    return (
      <Slot
        data-slot="button"
        className={cn(
      ...
      >
        {React.cloneElement(children, {}, (
          <>
            ...
            <div className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-[inherit]" style={{ backdropFilter: 'url("#container-glass")' }} />
            <div className="pointer-events-none z-10 w-full h-full flex items-center justify-center gap-inherit">
